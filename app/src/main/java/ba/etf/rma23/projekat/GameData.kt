...
import ba.etf.rma23.projekat.UserRating
import ba.etf.rma23.projekat.UserReview

class GameData {
    companion object{
         fun getAll() : List<Game> {
            return listOf(
                Game(1,"Fifa 23","PS5","2022-27-09",4.1,"fifa23",
            "E","Jon Jones","EA Sports","sport","FIFA 23 features the men's World Cup game mode and is reported to feature the women's World Cup game mode in the future, replicating the 2022 FIFA World Cup and the 2023 FIFA Women's World Cup.",
                mutableListOf(
                    UserRating("kdizdarevi1",1649182100000,3.5),
                    UserReview("ali123",1670718100000,"This game is super fun!"),
                    UserReview("aa",1643855700000,"Didn't have a good time playing this game, too many ads..."),
                    UserRating("ja",1665391700000,4.5),
                    UserRating("kenankd",1639012500000,1.0)
                )
            ), Game(2,"NBA 2K23","PS4","2022-09-01",4.4,"nba23",
                ...
                mutableListOf(
                    UserReview("faris123",1673290900000,"Amazing graphics and movement of players"),
                    UserRating("JoshJJ",1653201300000,2.0),
                    UserReview("JonJones",1662465300000,"Had a great experience with this game! I would recommend it to everyone!"),
                    UserRating("TysonMike",1630511700000,2.5),
                    UserRating("Tarik123",1684382100000,3.0)
                )),
                Game(3,"Call Of Duty Black Ops III","Xbox One","2014-03-03",4.8,"bo3",
                    ...
                    listOf()),
                Game(4,"Rocket League","PC","2019-28-01",3.5,"rocketleague",
                    ...
                    listOf()),
                Game(5,"Pro Evolution Soccer 13","PS3","2012-28-09",5.0,"pes13",
                    ...
                    listOf()),
                Game(6,"Fortnite","PS4","2014-01-01",4.5,"fortnite",
                ...
                Game(9,"League of Legends","PS4","2010-22-01",3.75,"lol",
                    ...
                    listOf()),
                Game(99,"Grand Theft Auto V","PS4","2014-01-01",4.9,"gta5",
